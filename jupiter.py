...
def cfgname():
    ...
    # cfgname="parisf.dss.cuda@0.batch@16.lr@40.loss@infoNCE" # 84.20
    ...
    # cfgname="parisf.dssaccl.cuda@0.batch@16.lr@40.loss@infoNCEWeightedDirect.k@32.ne"  
    cfgname="parisf.dssaccl.cuda@1.batch@16.lr@40.loss@infoNCEWeightedDirect.k@8.ne"
