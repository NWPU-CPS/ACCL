...
def cfgname():
    ...
    # cfgname="parisf.dssaccl.cuda@3.batch@16.lr@20.loss@infoNCEWeightedDirect.k@8.ne" # 84.96 ? 78.92
    # cfgname="parisf.dssaccl.cuda@2.batch@16.lr@20.loss@infoNCEWeightedDirect.k@16.ne" 78.75
    cfgname="parisf.dssaccl.cuda@1.batch@16.lr@100.loss@infoNCEWeightedDirect.ne"
